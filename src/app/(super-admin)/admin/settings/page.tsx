      ...
      <form action={async (formData) => {
        ...
        <div className="space-y-6">
          ...
          <Card className="bg-[#111] border-white/10">
            <CardHeader>
              <CardTitle className="flex items-center gap-2 text-white">
                <AlertTriangle className="h-5 w-5 text-yellow-500" /> Global Announcement
              </CardTitle>
              <CardDescription>
          ...
          <div className="flex justify-end">
            <Button type="submit" className="bg-primary text-black font-bold hover:bg-primary/90" size="lg">
              Save Configuration
            </Button>
          </div>
