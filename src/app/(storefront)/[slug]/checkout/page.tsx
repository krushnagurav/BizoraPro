                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      type="tel"
                      className="h-12 pl-24 bg-white border-slate-200"
                      required
                    />
                  </div>
          ...
          <div className="lg:col-span-5 space-y-6">
            <Card className="bg-white border-gray-100 shadow-lg sticky top-28">
              ...
              <CardContent className="space-y-6 pt-6">
                ...
                <Button
                  className="w-full h-14 text-lg font-bold bg-[#E6B800] text-black hover:bg-[#FFD700] shadow-lg shadow-[#E6B800]/20 rounded-xl gap-2"
                  disabled={loading}
                  type="submit"
                >
                  {loading ? (
                ...
                <div className="space-y-3 pt-4">
                  ...
                  <div className="flex items-center gap-3 text-xs text-slate-500">
                    <Headset className="w-4 h-4 text-purple-600" /> Direct
                    Business Support
                  </div>
                </div>
              </CardContent>
