...
import { ArrowLeft, ShieldCheck, Scale, RotateCcw, Lock } from "lucide-react";
      ...
      <div className="max-w-3xl mx-auto px-4 py-12 space-y-8">
        ...
        <div className="text-center space-y-4 mb-12">
           ...
           <p className="text-slate-500 max-w-md mx-auto">
             Transparency is key. Read our policies below to understand how we operate and protect your rights.
           </p>
        </div>
        ...
        <div className="text-center pt-12 border-t border-slate-200">
          <p className="text-xs text-slate-400">
            These policies are set by <strong>{shop.name}</strong>. 
            BizoraPro is the platform provider and is not responsible for shop-specific operations.
          </p>
        </div>
...
function PolicyCard({ title, updated, content, icon: Icon }: { title: string, updated: string, content: string, icon: any }) {
  return (
