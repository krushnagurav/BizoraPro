  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid md:grid-cols-3 gap-6">
        {plans?.map((plan) => (
          <Card key={plan.id} className="bg-[#111] border-white/10 text-white relative overflow-hidden">
            {plan.is_popular && (
            ...
            <CardContent className="p-6 space-y-4">
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <Badge variant="outline" className="mt-2 border-white/20 text-gray-400">
              ...
              <div className="pt-4 border-t border-white/10">
                <div className="flex items-baseline gap-1">
                  <span className="text-3xl font-bold text-primary">₹{plan.price_monthly}</span>
