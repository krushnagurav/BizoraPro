      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <Card className="bg-card border-border/50">
          <CardHeader>
            ...
            <CardDescription>Upload a cover image for your shop (1200x400px recommended).</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="border-2 border-dashed border-border/50 rounded-xl p-8 bg-secondary/10 hover:bg-secondary/20 transition-colors">
               ...
               {!bannerUrl && (
                 <div className="mt-4 text-center pointer-events-none">
                    ...
                    <p className="text-xs text-muted-foreground/50">JPG, PNG (MAX. 5MB)</p>
                 </div>
               )}
            </div>
          </CardContent>
        ...
        <Card className="bg-card border-border/50">
          <CardHeader>
            ...
            <CardDescription>Your brand icon (Square image recommended).</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="flex items-start gap-6">
               <div className="w-32 h-32 border-2 border-dashed border-border/50 rounded-xl flex items-center justify-center bg-secondary/10 hover:bg-secondary/20 transition-colors relative overflow-hidden">
                  ...
                  {!logoUrl && <ImageIcon className="w-8 h-8 text-muted-foreground/50 pointer-events-none absolute" />}
               </div>
               <div className="space-y-2 pt-2">
                  <p className="text-sm font-bold text-foreground">{shopName || "Your Shop"}</p>
                  <p className="text-xs text-muted-foreground max-w-xs">
                     This logo will appear on your shop header, checkout page, and WhatsApp messages.
                  </p>
               </div>
            </div>
          </CardContent>
        ...
        <Card className="bg-card border-border/50">
          <CardHeader>
            ...
            <CardDescription>Pick a main color for your buttons and highlights.</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <div className="pt-4">
           <Button size="lg" className="font-bold bg-primary text-black hover:bg-primary/90" disabled={loading}>
             {loading ? <Loader2 className="animate-spin mr-2" /> : "Save Appearance"}
           </Button>
        </div>
