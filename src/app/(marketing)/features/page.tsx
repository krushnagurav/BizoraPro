...
export default function FeaturesPage() {
  ...
  const spotlights = [
    ...
    },
    {
      ...
      title: (
        <>
          Seamless <span className="text-primary">WhatsApp ordering flow</span>
        </>
      ),
      icon: MessageCircle,
      list: [
    ...
    },
    {
      ...
      title: (
        <>
          Manage your shop <span className="text-primary">from any device</span>
        </>
      ),
  ...
  return (
    <>
      ...
      >
        <div
          className="pointer-events-none absolute top-0 left-1/2 h-[420px] w-[780px] -translate-x-1/2 rounded-full bg-primary/10 blur-[120px] opacity-35"
          aria-hidden="true"
        />
            ...
            {features.map((item, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <h3
                    id={titleId}
                    className="mb-2 text-base md:text-lg font-semibold text-white"
                  >
                    {item.title}
                  </h3>
      ...
      {spotlights.map(({ id, label, title, icon: Icon, list, reverse }) => (
        <section
          ...
          className={`${reverse ? "bg-[#050507]" : "bg-background"} py-16 md:py-24`}
        >
          <div
      ...
      >
        <div
          className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_center,_rgba(234,179,8,0.25),_transparent_60%)]"
          aria-hidden="true"
        />
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
            <Button
              ...
              className="h-12 md:h-14 px-8 md:px-10 text-sm md:text-lg font-bold bg-primary text-black hover:bg-primary/90"
            >
              <Link href="/signup" aria-label="Start free BizoraPro trial">
                <span className="inline-flex items-center gap-2">
                  Start free trial
                  <ArrowRight
                    aria-hidden="true"
            ...
            >
              <Link href="/examples" aria-label="View sample BizoraPro shops">
                View sample shops
              </Link>
            </Button>
          </div>
