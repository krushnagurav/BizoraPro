      ...
      <div className="bg-green-500/10 border border-green-500/20 rounded-lg p-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <span className="text-green-500 font-medium">
            Payment successful via {inv.payment_method} on{" "}
            ...
            <div className="grid grid-cols-2 gap-8">
              <div>
                ...
                <p className="text-gray-400 text-sm">
                  {inv.shops?.whatsapp_number || "No Phone"}
                </p>
                <p className="text-gray-400 text-sm mt-1">
                  {inv.shops?.slug}.bizorapro.com
                </p>
              </div>
                  ...
                  <tr>
                    <td className="px-4 py-4">
                      <span className="block text-white font-medium">
                        BizoraPro Subscription
                      </span>
                      <span className="text-xs text-gray-500">
                        Plan Upgrade ({inv.shops?.plan})
                      </span>
                    </td>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2 pt-2 border-t border-white/10">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span
                    className={
                      inv.shops?.is_open ? "text-green-400" : "text-red-400"
                    }
                  >
              ...
              <a
                href={`${process.env.NEXT_PUBLIC_APP_URL}/${inv.shops?.slug}`}
                target="_blank"
              >
