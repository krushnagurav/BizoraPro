    ...
    <div className="fixed bottom-4 left-4 right-4 z-50 max-w-md mx-auto">
      <div className="bg-foreground text-background p-4 rounded-xl shadow-2xl flex items-center justify-between animate-in slide-in-from-bottom-10 fade-in">
        <div className="flex flex-col">
          <span className="text-xs font-medium text-muted-foreground/80 uppercase tracking-wider">Total</span>
        ...
        <Link href={`/${slug}/cart`}>
          <Button size="sm" className="font-bold bg-primary text-black hover:bg-primary/90">
