...
import { Loader2, BellRing, Mail, MessageCircle, Package, AlertTriangle, Megaphone } from "lucide-react";
  ...
  return (
    <div className="p-8 max-w-3xl space-y-8">
      <div>
        ...
        <p className="text-muted-foreground">Control how and when we contact you.</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <Card className="bg-card border-border/50">
          <CardHeader>
            ...
            <CardDescription>Receive updates directly to your registered email.</CardDescription>
          </CardHeader>
            ...
            <div className="flex items-center justify-between p-3 rounded-lg hover:bg-secondary/10 transition">
              <div className="flex gap-3 items-start">
                 ...
                 <div className="space-y-0.5">
                   ...
                   <p className="text-xs text-muted-foreground">Get an email immediately when a customer places an order.</p>
                 </div>
              </div>
              <Switch 
            ...
            <div className="flex items-center justify-between p-3 rounded-lg hover:bg-secondary/10 transition">
              <div className="flex gap-3 items-start">
                 ...
                 <div className="space-y-0.5">
                   ...
                   <p className="text-xs text-muted-foreground">Alert when a product inventory drops below 5 units.</p>
                 </div>
              </div>
              <Switch 
          ...
          <CardContent className="space-y-6">
            ...
            <div className="flex items-center justify-between opacity-60 p-3 rounded-lg border border-dashed border-border/50">
              <div className="space-y-0.5">
                ...
                <p className="text-xs text-muted-foreground">Receive full order details on your WhatsApp number.</p>
              </div>
              <div className="flex items-center gap-2">
                 <span className="text-[10px] bg-primary/20 text-primary px-2 py-0.5 rounded uppercase font-bold">Coming Soon</span>
