...
export default function AboutPage() {
  return (
    <>
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 gap-7 md:grid-cols-3">
            {[
              ...
              >
                <div className="mb-5 flex h-12 w-12 items-center justify-center rounded-xl border border-primary/20 bg-primary/10 transition-colors group-hover:bg-primary/20">
                  <item.icon
                    aria-hidden="true"
        ...
        <div className="relative flex flex-col items-center gap-12 overflow-hidden rounded-3xl border border-white/10 bg-[#0C0C10] p-8 md:flex-row md:gap-16 md:p-14">
          ...
          <div className="relative z-10 flex-1 space-y-6">
            ...
            <div className="space-y-4 text-sm leading-relaxed text-slate-200 md:text-lg">
              ...
              <p>
                ...
                your identity — a simple way to say, ‘We are professional. You
                can trust us.’”
              </p>
            </div>
          ...
          <div className="relative z-10 flex flex-1 justify-center">
            <div className="flex h-56 w-56 items-center justify-center rounded-full border border-white/10 bg-[#15151F] shadow-2xl shadow-black/60 md:h-64 md:w-64">
              {/* Placeholder avatar / team icon – replace with real photo later */}
              <Users
                aria-hidden="true"
      ...
      {/* BOTTOM CTA */}
      <section className="mx-auto max-w-4xl px-4 pb-16 text-center sm:px-6 md:pb-20 lg:px-8">
