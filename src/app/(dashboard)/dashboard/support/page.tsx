      ...
      <Card className="bg-card border-border/50 hover:border-primary/30 transition cursor-pointer group">
        <CardContent className="p-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            <div
              className={`p-2 rounded-full bg-secondary ${ticket.status === "resolved" ? "text-green-500" : "text-primary"}`}
            >
          ...
          <div className="text-right">
            <Badge
              variant="outline"
              className={`${priorityColors[ticket.priority]} border-opacity-20 bg-opacity-10 capitalize`}
            >
              {ticket.priority}
            </Badge>
